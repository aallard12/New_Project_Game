...
int main() {
    ...
    */
    ...
    do {
        ...
        switch(touche){
            case 1:{
                Archer archer1(100,20,1);
                cout << "Tu as choisi l'Archer 🏹 !" << endl;
                this_thread::sleep_for(chrono::seconds(4));
                break;
            }
            case 2:{
                Boxeur boxeur1(100,20,false);
            ...
            case 5:{
                Cowboy cowboy1(100,20,false);
                cout << "Tu as choisi le Cowboy 🤠 !" << endl;
                this_thread::sleep_for(chrono::seconds(4));
                break;
            }
            case 6:{
                Druide druide1(100,20);
            ...
            case 8:{
                MoineGuerrier moineguerrier1(100,20);
                cout << "Tu as choisi le Moine Guerrier 🧘 !" << endl;
                this_thread::sleep_for(chrono::seconds(4));
                break;
            }
            case 9:{
                Ninja ninja1(100,20,false);
